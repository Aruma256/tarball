...
public class AdjustRangeKey extends LTKeyBase implements HudRenderCallback {
	...
	public void onHudRender(PoseStack matrixStack, float tickDelta) {
		...
		if (rayTraceResult == null || rayTraceResult.getType() == HitResult.Type.MISS) {
			...
			dist = Math.min(LotTweaks.CONFIG.MAX_RANGE, mc.player.getEyePosition(tickDelta).distanceTo(rayTraceResult.getLocation()));
		}
